...
- Add sample enviornment file.

### Changed

- Update README instructions for NVIDIA drivers, MySQL drivers, and Systemd Service.
- Update sample service files.
- Update pip packages.
...
- Track Python version in .python-version.
- Print exceptions on process submission.
- Update Django, pyannote.audio, and yt-dlp.
- Update diarization code for pyannote.audio v4.0.0.
- Disable diarize radio if settings are not configured.
